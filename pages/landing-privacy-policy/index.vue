<template>
  <div class="landing-privacy-policy">
    <div class="landing-privacy-policy__header">
      <div class="container">
        <Header class="" />
      </div>
    </div>

    <div class="landing-privacy-policy__content">
      <div class="container">
        <BaseHeadline title="Privacy Policy" />

        <BaseTitle
          type="h3"
          class="landing-privacy-policy__content-title landing-privacy-policy__content-title-underline"
        >
          This policy is effective as of 31 July 2019.
        </BaseTitle>

        <div class="landing-privacy-policy__content-text">
          This privacy policy explains how HOLDERLAB (hereinafter
          <span class="bold">“Holderlab”</span> or
          <span class="bold">“We”</span> / <span class="bold">“Us”</span> or
          <span class="bold">“Our“</span>) offers online software as a service
          through https://www.holderlab.io (<span class="bold">“Website”</span
          >), which has related and embedded services, social networks, collects
          your personal information and explains in this privacy policy how it
        ...
        <BaseTitle 
          type="h3" 
          class="landing-privacy-policy__content-title">
          1. Information we collect
        </BaseTitle>

        <div class="landing-privacy-policy__content-text">
          <span class="bold">Log data</span><br >
          ...
          time spent on each page, and other details. <br ><br >
          <span class="bold">Device data</span> <br >
          ...
          available to us. <br ><br >
          <span class="bold">Personal information</span> <br >
          We may ask for personal information, when you fill out the register
          form or when you provide your payment details, such as your:<br >
          - Name<br >
          - Email<br >
          - Date of birth<br >
          - Home/Mailing address (Payment information)<br >
          - Work address (For Business Account)<br >
          - Payment information<br >
          - Tax Identifier (VAT)<br >
          ...
          of use and privacy policy of the service when you agree to register on
          the web service (https://www.holderlab.io)<br ><br >
          <span class="bold">Business data</span><br >
        ...
        <div class="landing-privacy-policy__content-text">
          ...
          where we have legal bases for doing so. <br >
          These legal bases depend on the services you use and how you use them,
          meaning we collect and use your information only where:<br >
          ...
          you might consent to us sending you our newsletter);<br >
          ...
          will not affect any processing that has already taken place).<br ><br >
        ...
        <div class="landing-privacy-policy__content-text">
          ...
          manner that is incompatible with these purposes:<br >
          - to provide you with our platform’s core features;<br >
          ...
          associated social media platforms;<br >
        ...
        <div class="landing-privacy-policy__content-text">
          ...
          disclosure of these third parties. <br ><br >
        ...
        <div class="landing-privacy-policy__content-text">
          <span 
            class="bold"
          >How we protect your information and personal data.</span
          >
          <br >
          ...
          ways to administer your personal data.<br ><br >
          <span class="bold">Choice and consent:</span> <br >
          ...
          in accordance with this privacy policy. You are not required to
          ...
          services offered on or through it.<br ><br >
          <span class="bold">Information from third parties:</span><br >
          If we receive personal information about you from a third party, we
          will protect it in accordance with this privacy policy. If you are a
          ...
          provide us with this personal information.<br ><br >
          <span class="bold">Limit:</span><br >
          ...
          affects your use of our website or products and services.<br ><br >
          <span class="bold">Access and transfer of data:</span><br >
          ...
          data by logging in to your account on the web service.<br ><br >
          <span class="bold">Correction:</span><br >
          ...
          service.<br ><br >
          <span class="bold">Unsubscribe:</span> <br >To unsubscribe from our
        ...
        <div class="landing-privacy-policy__content-text">
          ...
          significant change to this privacy policy, for example changing a
          lawful basis on which we process your personal information, we will
          ask you to re-consent to the amended privacy policy.
        </div>

        <BaseTitle 
          type="h3" 
          class="landing-privacy-policy__content-title">
          9. Your acceptance of our privacy policy and terms of use
        </BaseTitle>

        <div class="landing-privacy-policy__content-text">
          By using this site, you agree to this privacy policy and terms of use.
          If we change the privacy policy and terms of use and publish them, we
          will automatically consider your acceptance of these changes. If you
          do not agree to this privacy policy and terms of use, please do not
          use our services.
        </div>
        ...
        <div class="landing-privacy-policy__content-text">
          ...
          us: contacts@holderlab.io <br >
          Updated on July 31, 2019
        </div>
      </div>
    </div>

    <div class="landing-privacy-policy__footer">
      <div class="container">
        <div class="landing-privacy-policy__footer-socnets">
